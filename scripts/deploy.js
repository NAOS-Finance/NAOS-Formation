...
async function main() {
    ...
    const formation = await Formation.deploy(daiToken.address, nUSD.address, governance, sentinel)
    ...
    const transmuter = await Transmuter.deploy(daiToken.address, nUSD.address, governance)
